...
var Theme = /*#__PURE__*/function () {
  ...
  _createClass(Theme, [{
    ...
    value: function initSwitchTheme() {
      ...
      this.util.forEach(document.getElementsByClassName('theme-switch'), function ($themeSwitch) {
        $themeSwitch.addEventListener('click', function () {
          if (document.body.getAttribute('data-color-mode') === 'dark') document.body.setAttribute('data-color-mode', 'light');else document.body.setAttribute('data-color-mode', 'dark');
    ...
    value: function initSearch() {
      ...
      this._searchOnClickMask = this._searchOnClickMask || function () {
        _this2._search && _this2._search.autocomplete.setVal('');
      };

      this.clickMaskEventSet.add(this._searchOnClickMask);

      var initAutosearch = function initAutosearch() {
        var autosearch = autocomplete("#search-input", {
          hint: false,
          autoselect: true,
          ...
          templates: {
            suggestion: function suggestion(_ref5) {
              ...
              return "<div class=\"suggestion-row\"><span class=\"suggestion-title\">".concat(title, "</span><span class=\"suggestion-date\">").concat(date, "</span></div><div class=\"suggestion-context\">").concat(context, "</div>");
            },
    ...
    value: function init() {
      ...
      try {
        this.initSVGIcon();
        this.initTwemoji(); // this.initMenuMobile();
